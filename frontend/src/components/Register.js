                        ...
                        <Form>
                            ...
                            <div className="field">
                                ...
                                <div className="controls">
                                    <Field name="nom" type="text" placeholder="Nom" autoComplete="off" className="input is-rounded"></Field>
                                </div>
                            ...
                            <div className="field">
                                ...
                                <div className="controls">
                                    <Field name="prenom" type="text" placeholder="Prénom" autoComplete="off" className="input is-rounded"></Field>
                                </div>
                            ...
                            <div className="field">
                                ...
                                <div className="controls">
                                    <Field name="email" type="text" placeholder="Email" autoComplete="off" className="input is-rounded"></Field>
                                </div>
                            ...
                            <div className="field">
                                ...
                                <div className="controls">
                                    <Field name="password" type="password" placeholder="******" autoComplete="off" className="input is-rounded"></Field>
                                </div>
                            ...
                            <div className="field">
                                ...
                                <div className="controls">
                                    <Field name="confPassword" type="password" placeholder="******" autoComplete="off" className="input is-rounded"></Field>
                                </div>
                                <ErrorMessage name="confPassword" component="p" className="notification is-danger is-light p-2 mt-1" />
                            </div>
                            <button type='submit' className="button is-link is-outlined mt-2 is-danger">Inscription</button>
                        </Form>
                    </Formik>
                </div>
            </div>
