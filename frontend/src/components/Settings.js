...
const Dashboard = () => {
    ...
    // Fonction de refresh et decodage du token
    ...
    // Fonction axios pour les requêtes HTTP
    ...
    return (
        <>
            <div className="message is-dark">
                <h2 className={isAdmin === 1 ? ("message-header has-background-danger") : ("message-header has-background-danger")}>Mes informations</h2>
